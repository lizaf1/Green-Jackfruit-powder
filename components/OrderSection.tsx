      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 items-stretch max-w-6xl mx-auto">
          {variants.map((variant, idx) => {
            // Use variant-specific links if available, else fallback to global links
            const waLink = variant.linkWA || t.order.linkWA;
            const shopeeLink = variant.linkShopee || t.order.linkShopee;
            const tiktokLink = variant.linkTikTok || t.order.linkTikTok;
        ...
        <div className="mt-16 text-center">
          <p className="text-[11px] font-black text-gray-400 uppercase tracking-[0.4em] flex items-center justify-center gap-3 opacity-60">
