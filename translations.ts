...
const translationsID: Translations = {
  common: {
    brandTagline: "Terapi Nutrisi Medis (MNT) Bubuk Nangka Hijau Mentah",
  ...
  hero: {
    ...
    description: "Satu-satunya Bubuk Nangka Hijau Mentah yang terbukti secara klinis dalam Uji Coba Terkontrol Acak (RCT) untuk menurunkan HbA1c, Gula Darah Puasa (FPG), dan Gula Darah Pasca Makan (PPG).",
    ctaEvidence: "Lihat Hasil Studi Nature",
    chartLabel: "HbA1c Reduction",
    heroImage: "https://images.unsplash.com/photo-1589182373726-e4f658ab50f0?auto=format&fit=crop&q=80&w=1200"
  },
  order: {
    heading: "Mulai Terapi Nutrisi Medis",
    subheading: "Cukup tambahkan 1 sdm Bubuk Nangka Hijau ke dalam makanan pokok Anda setiap hari untuk manajemen glikemik yang lebih baik.",
    ...
    benefitRaw: "100% Bubuk Nangka Hijau Mentah",
    benefitProven: "Efikasi Signifikan Teruji",
    benefitClean: "Tanpa Pengawet & Gula",
    benefitCold: "Cold-Processed (<50°C)"
  },
  blog: { heading: "Pusat Edukasi Glikemik", subheading: "Wawasan mendalam mengenai kesehatan metabolisme dan serat Bubuk Nangka Hijau.", readMore: "Baca", backToBlog: "Kembali", viewAll: "Lihat Semua", readArticle: "Baca Artikel" },
  evidence: {
    ...
    analysisDesc: "Dipublikasikan di Scientific Reports (Nature Portfolio), mengonfirmasi peran Bubuk Nangka Hijau sebagai terapi nutrisi yang efektif bagi penderita Diabetes Tipe 2.",
    ...
    coldProcessDesc: "Cukup tambahkan sesendok Bubuk Nangka Hijau ke dalam porsi makanan harian Anda untuk membantu menurunkan beban glikemik tanpa merubah rasa.",
  ...
  usage: {
    ...
    riceTitle: "Campuran Nasi", riceDesc: "Tambahkan 1 sdm Bubuk Nangka Hijau untuk setiap cup beras sebelum dimasak.",
    flourTitle: "Campuran Tepung", flourDesc: "Campurkan 1 sdm Bubuk Nangka Hijau untuk setiap 3 sdm tepung terigu atau adonan.",
  ...
  faq: { heading: "Pertanyaan Umum", subheading: "Informasi teknis mengenai penggunaan klinis Bubuk Nangka Hijau mentah." },
...
export const getDefaultContent = (lang: 'id' | 'en'): AppContentData => {
  const data: Record<'id' | 'en', AppContentData> = {
    id: {
      ...
      recipes: [
        { name: 'Nasi Rendah GI', description: 'Nasi putih pulen dengan beban glikemik 40% lebih rendah.', howToAdd: 'Tambahkan 1 sdm Bubuk Nangka Hijau per cup beras.', image: 'https://images.unsplash.com/photo-1516684732162-798a0062be99?auto=format&fit=crop&q=80&w=800' },
        { name: 'Roti MNT Sehat', description: 'Roti gandum dengan tambahan serat fungsional nangka.', howToAdd: 'Campurkan Bubuk Nangka Hijau ke dalam adonan tepung.', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&q=80&w=800' },
